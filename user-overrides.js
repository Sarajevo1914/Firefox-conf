...
/*******************************************************************************
 * SECTION: SEARCH ENGINE CONFIGURATION                                       *
 *******************************************************************************/

// Set DuckDuckGo as default search engine
user_pref("browser.search.defaultenginename", "DuckDuckGo"); // Default search engine name
user_pref("browser.search.selectedEngine", "DuckDuckGo"); // Currently selected search engine
user_pref("browser.search.defaultenginename.US", "DuckDuckGo"); // Default for US region
...
// user_pref("browser.search.hiddenOneOffs", "Google,Bing,Amazon.com,Wikipedia (en)"); // Hide these engines from search bar
...
// Disable problematic privacy features
user_pref("privacy.globalprivacycontrol.enabled", false); // Don't send "don't sell my data" signal (may break sites)
user_pref("browser.safebrowsing.malware.enabled", false); // Disable malware checking (avoids Google queries)
user_pref("browser.safebrowsing.phishing.enabled", false); // Disable anti-phishing protection (avoids Google queries)
...
user_pref("signon.rememberSignons", false); // Don't remember passwords in Firefox
...
user_pref("signon.management.page.breach-alerts.enabled", false); // Don't show security breach alerts
user_pref("signon.firefoxRelay.feature", "disabled"); // Disable Firefox Relay (temporary email service)
...
user_pref("media.eme.enabled", true); // Enable DRM content playback (Netflix, Spotify, etc.)
user_pref("browser.eme.ui.enabled", true); // Show DRM settings in interface
user_pref("media.gmp-widevinecdm.enabled", true); // Enable Widevine CDM for protected content
...
user_pref("gfx.webrender.all", true); // Force WebRender for better graphics performance
...
user_pref("media.autoplay.default", 5); // Autoplay control: 0=allow, 1=block, 5=block all
user_pref("media.autoplay.blocking_policy", 2); // Blocking policy: 0=sticky, 1=transient, 2=per-origin
...
// Disable telemetry (additional to BetterFox)
user_pref("datareporting.healthreport.uploadEnabled", false); // Don't send health reports
...
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true); // Allow custom CSS stylesheets

// Developer tools (optional)
// user_pref("devtools.theme", "dark"); // Dark theme for developer tools
// user_pref("devtools.toolbox.host", "bottom"); // Position tools at bottom

// Advanced network settings
user_pref("network.http.max-connections", 1800); // Maximum simultaneous HTTP connections
user_pref("network.http.max-persistent-connections-per-server", 10); // Persistent connections per server

// Canvas fingerprinting (uncomment if you want to block it)
// user_pref("privacy.resistFingerprinting.canvas", true); // Resist canvas fingerprinting
...
user_pref("browser.cache.memory.capacity", 512000); // Memory cache: 512MB for better performance
user_pref("browser.sessionhistory.max_total_viewers", 8); // More pages in cache for fast navigation
user_pref("network.dnsCacheExpiration", 3600); // DNS cache for 1 hour (reduces DNS queries)

/*******************************************************************************
 * SECTION: AUTOMATIC UI CUSTOMIZATIONS                                       *
 *******************************************************************************/
